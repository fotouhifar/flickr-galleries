...
if (!class_exists('phpFlickr')) {
    ...
    class phpFlickr {
        ...
        var $api_key = '065f5e2cfd6a68b0a5055db556216e67';
        var $secret='f76b8a6c2a136134';
        ...
        function auth($perms = "read", $remember_uri = true) {
            ...
            if (empty($_SESSION['phpFlickr_auth_token']) && empty($this->token)) {
                ...
                echo "https://www.flickr.com/services/auth/?api_key=" . $this->api_key . "&perms=" . $perms . "&api_sig=" . $api_sig;
